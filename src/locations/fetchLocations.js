async function getWildLocations(locations){
    ...
    const rawWildLocations = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/locations/wild_encounter_tables.c`)
...
async function getRaidLocations(locations){
    const rawRaidLocations = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/locations/raid_encounters.h`)
...
async function getManualLocations(locations){
    const rawManualLocations = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/locations/manualLocations.js`)
