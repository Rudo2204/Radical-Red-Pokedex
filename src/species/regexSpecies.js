    ...
    await lines.forEach(line => {
        ...
        if(startFound){
            ...
            if(matchMove){
                ...
                const rawTMHM = fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/species/tm_compatibility/${count} - ${move}.txt`)
                .then(promises => {
        ...
        if(startFound){
            ...
            if(matchMove){
                ...
                if(filterUnusedTutor.includes(move)){
                    const rawTutor = fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/species/tutor_compatibility/${count} - ${move}.txt`)
                    .then(promises => {
...
async function regexSprite(textSprite, species){
    ...
    await lines.forEach(line => {
        ...
        if(matchSpecies){
            ...
            if(matchURL){
                let url = `file:///home/rudo/Games/Radical-Red-Pokedex/data/species/frontspr/${matchURL[0].replace("Tiles", ".png")}`
