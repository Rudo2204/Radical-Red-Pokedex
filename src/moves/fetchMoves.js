async function getMoves(moves){
    ...
    const rawMoves = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/moves/battle_moves.c`)
...
async function getMovesDescription(moves){
    const rawMovesDescription = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/moves/attack_descriptions.string`)
...
async function getMovesIngameName(moves){
    const rawMovesIngameName = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/moves/attack_name_table%20long.string`)
...
async function getMovesFlags(moves){
    const rawMovesFlags = await fetch(`file:///home/rudo/Games/Radical-Red-Pokedex/data/moves/move_tables.s`)
